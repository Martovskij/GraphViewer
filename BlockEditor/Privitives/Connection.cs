  ...
  public sealed class ConnectionViewModel : AbstractModelBase
  {
    ...
    public ConnectorViewModel SourceConnector
    {
      ...
      set
      {
        ...
        if (sourceConnector != null)
        {
          ...
          sourceConnector.AttachedConnections.Clear();
          sourceConnector.HotspotUpdated -= this.sourceConnector_HotspotUpdated;
        }
    ...
    public ConnectorViewModel DestConnector
    {
      ...
      set
      {
        ...
        {
          Trace.Assert(destConnector.AttachedConnections.Any());

          destConnector.AttachedConnections.Clear();
