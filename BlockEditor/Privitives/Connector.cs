...
namespace NetworkModel
{
  ...
  public sealed class ConnectorViewModel : AbstractModelBase
  {
    ...
    private readonly List<ConnectionViewModel> attachedConnections = new List<ConnectionViewModel>();

    public List<ConnectionViewModel> AttachedConnections
    {
      get { return this.attachedConnections; }
    }

    public void AddAttachedConnection(ConnectionViewModel connection)
    {
